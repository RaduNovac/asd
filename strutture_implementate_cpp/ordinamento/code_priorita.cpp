//Code di massima priorità implementate con gli heap | ASD in C++ | Work in progress

/* 
    g++ code_priorita.cpp -o code_priorita
    ./code_priorita
*/
#include <iostream>
...
int heap_extract(int A[], int n){// n è A.heap_size
    if(n < 1){
        return -1;
    }
    else{
